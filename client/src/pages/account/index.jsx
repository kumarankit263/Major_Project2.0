...
// import { userLogin, sellerLogin } from "../../redux/actions";
// import InputTag from "../../components/input/InputTag";
// import SubmitButton from "../../components/button/SubmitButton";
// import FormSwitch from "../../components/account/FormSwitch";
// import SideImage from "../../components/account/SideImage";
...
//     if (isSignInForm) {
//       handleLogin(type, formData);
//       dispatch(type === "seller" ? sellerLogin(userData) : userLogin(userData));
//     } else {
//       handleSignup(type, formData);
//     }
//   };
...
//   useEffect(() => {
//     if (user || seller) {
//       const userName = user?.name || seller?.name || "User";
//       toast.success(`Welcome ${userName}`);
//     }
//   }, [user, seller]); // Run this whenever user/seller changes
...
//               isLoading={isLoading}
//             />
//             <FormSwitch type={type} isSignInForm={isSignInForm} setIsSignInForm={setIsSignInForm} />
...
//             ) : (
//               <div className="text-xs font-medium text-rose-600">
//                 *It is recommended to use temporary mail for creating an account.{" "}
